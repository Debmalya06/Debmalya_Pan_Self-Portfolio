  ...
  const certifications = [
    {
      ...
      issuer: "Udemy",
      date: "2024",
      link: "https://drive.google.com/file/d/1kbDn1cZbL1VegSkiP3QThqsf54dPR_g-/view?usp=drivesdk",
    ...
    },
    {
      ...
      date: "2024",
      link: "https://drive.google.com/file/d/1kbynLKB3rdP4z9Dgwzr4q4dRJqw1RaUH/view",
      icon: <FaCertificate size={24} className="text-yellow-500" />,
    },
    {
      ...
      issuer: "NPTL",
      date: "2024",
      link: "https://drive.google.com/file/d/1kbtD77-QiSvb6ZbOZ2WvXPpZDkrZoUOu/view",
      icon: <FaCertificate size={24} className="text-yellow-500" />,
    },
    {
      ...
      issuer: "EduSkill",
      date: "2023",
      link: "https://drive.google.com/file/d/1kk16l7Sp3Fk8GkM3hPFxz-yEI9roOHNu/view",
      icon: <FaCertificate size={24} className="text-yellow-500" />,
    },
  ]
